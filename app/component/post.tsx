...
export function Post(props: Props): JSX.Element {
  return (
    <div className="bg-white/70 border boder-white/50 mb-10 rounded-[40px] p-8 hover:-translate-y-2 transition-all duration-500 ease-in-out hover:shadow-2xl hover:shadow-[#6366F1]/30 cursor-pointer">
